...
class FootStepsWidget extends StatefulWidget {
  const FootStepsWidget({Key? key}) : super(key: key);



  @override
  _FootStepsWidgetState createState() => _FootStepsWidgetState();
}

class _FootStepsWidgetState extends State<FootStepsWidget>
  ...
  Widget build(BuildContext context) {
    List<int> stepsForLast7Days = HealthAppState.stepsForLast7Days;
    List date = HealthAppState.dateForgraph;
    int total = 0;
    double average1 = 0.0;
    int average = 0;
    int maximum = stepsForLast7Days.reduce(max);
    int minimum = stepsForLast7Days.reduce(min);
    for (var i in stepsForLast7Days) {
      total = total + i;
    }
    average1 = total / 7;
    average = average1.toInt();

    String maxdate = date.elementAt(stepsForLast7Days.indexOf(maximum));
    String mindate = date.elementAt(stepsForLast7Days.indexOf(minimum));
                        ...
                        child: Container(
                            ...
                            child: LineChart(
                              LineChartData(
                                ...
                                lineBarsData: [
                                  LineChartBarData(
                                    spots: stepsForLast7Days.asMap().entries.map((entry) {
